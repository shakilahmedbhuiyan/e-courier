                    ...
                    <td class="header"
                        ...
                        <a href="http://virs.ddns.net"
                           style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 19px; font-weight: bold; text-decoration: none; display: inline-block;">
                            <img src="https://res.cloudinary.com/retrieval-it/image/upload/v1619201989/E-Courier.svg" class="logo" alt="E-Courier Logo"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                       You payment has been
                                        <strong style="text-transform: capitalize">"{{__($status)}}"</strong>
                                    for the courier id#{{__($courier)}}.
                                    </p>
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        <a target="_blank" href="http://virs.ddns.net/courier/track/{{__($courier)}}" class="button" style="text-decoration: none; color:#86a4d9">
                                            Click Here</a> to track your parcel.</p>
                                    <br/>
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Thanks,<br>
                                        E-Courier</p>

                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 4px;letter-spacing: 5px; text-align: center;">
                                    This is an auto generated email. No confirmation or sign required.
                                    </p>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">
                                        © 2021 E-Courier. All rights reserved.</p>
